...
- **市场**：A 股、港股、美股、韩国 → 日本、欧洲、英国、新兴市场与跨境机制。
- **资产**：股票、基金/ETF、黄金、外汇 → 债券、商品、REIT、可转债与衍生品。
- **行业**：通用框架 → 存储、能源、金融、消费 → 医药、互联网及更多行业。
- **公司**：披露时点 → 三表勾稽 → 盈利质量 → 治理、资本配置与估值。
...
- `plugins/investing-research/`：可安装的只读金融仓库审计插件；采用规则见 `wiki/engineering/金融研究代码库审计.md`。
