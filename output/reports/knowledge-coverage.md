...
| `sector-real-estate` | 行业 | `content-ready` | 地产开发、运营与融资 | validated | 2026-07-18 | `synthesis:wiki/sectors/地产开发与运营.md`<br>`source:raw/official/united-states/census-housing-construction.md`<br>`implementation:src/investkb/sectors.py`<br>`test:tests/test_sectors.py` | — |
