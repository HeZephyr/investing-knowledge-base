...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。v2 初始基线为 36.5%；完成金融统计课程、只读代码库审计插件、全球市场与资产体系，以及十一项冻结证据能力后为 **60.6%**。分母已经加入此前未统计的训练、案例和维护缺口。
