...
面向完全新手的中文全球投资学习与量化研究仓库。它把原始来源、持续维护的 Wiki、免费行情代码和可复现研究放在一起，并可直接作为 Obsidian 仓库打开。首批可交易实现聚焦 A/HK，知识范围已扩展到美股、韩国市场、全球 ETF/基金、黄金、存储半导体、能源、金融和消费，并通过机器覆盖审计继续增加金融统计、地区、资产、行业与冻结数据案例。
...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。当前 v2 基线为 **36.5%**；它比旧版 60.4% 更低，是因为把粗粒度页面拆成了可验证能力，并显式加入此前未统计的缺口。
