...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。v2 初始基线为 36.5%；完成金融统计、代码库审计、全球市场资产、十一项冻结证据能力，以及基础学科、公司、研究方法与组合实验室后为 **85.5%**。基础学科 20/20、公司研究 16/16、研究方法 18/18、组合与风控 14/14 已验证，其余轴仍按真实缺口推进。
