...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。v2 初始基线为 36.5%；完成金融统计、代码库审计、全球市场资产、十一项冻结证据能力和公司研究实验室后为 **68.8%**。公司研究轴 16/16 已验证，其余轴仍按真实缺口推进。
