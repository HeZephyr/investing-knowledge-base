...
面向完全新手的中文全球投资学习与量化研究仓库。它把原始来源、持续维护的 Wiki、免费行情代码和可复现研究放在一起，并可直接作为 Obsidian 仓库打开。首批可交易实现聚焦 A/HK，知识范围已扩展到美股、韩国、日本、欧盟与新兴市场，以及全球 ETF/基金、债券、商品、黄金、存储半导体、能源、金融和消费，并通过机器覆盖审计继续增加统计训练、地区、资产、行业与冻结数据案例。
...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。v2 初始基线为 36.5%；完成金融统计课程、只读代码库审计插件、全球市场与资产体系，以及首批三套冻结案例后为 **53.2%**。它仍低于旧版粗粒度的 60.4%，因为分母已经加入此前未统计的训练、案例和维护缺口。
...
覆盖率表示仓库就绪度，不表示投资胜率或预期收益。当前 11 项案例能力中 3 项已经过冻结数据验证，8 项仍待完成；不会用空模板或叙事页伪装成实证完成。
