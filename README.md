...
[覆盖审计](output/reports/knowledge-coverage.md)把体系拆成基础学科、市场、资产、行业、公司、方法、组合和工程 8 个轴，共 135 项原子能力。v2 初始基线为 36.5%；完成金融统计课程、只读代码库审计插件及日本/欧盟/新兴市场、债券和商品体系后为 **51.0%**。它仍低于旧版粗粒度的 60.4%，因为分母已经加入此前未统计的训练、案例和维护缺口。
...
覆盖率表示仓库就绪度，不表示投资胜率或预期收益。当前 11 项案例能力为 0%，不会用空模板或叙事页伪装成实证完成。
